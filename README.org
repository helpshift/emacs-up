...
* Installation
  ...
  - Out of the box, ~emacs-up~ supports development on Clojure
    versions ~1.8~ and above. If you are someone who has to program
    against Clojure 1.7, 1.6 or older versions, refer to the section
    below this one on instructions to do that.
    ...
    + The contents of the file should be as follows:
      #+begin_src clojure
        {:user {:plugins [[cider/cider-nrepl "0.18.0"]
                ...
                :dependencies [^:replace [org.clojure/tools.nrepl "0.2.13"]]}}
      #+end_src
