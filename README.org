...
Helpshift. ~emacs-up~ is currently configured for Clojure programming
only, but I'm hoping that it will soon be expanded to include other
...
* Updating Emacs Up
  The current version of ~emacs-up~ is ~v3.2.0~. If you are updating
